...
/bookmarks - твои закладки по книге""",
   ...
   'not_marks': '''Ты ещё не добавил ни одну закладку, чтобы их добавить нажми на их номер страницы
Напоминаю) /continue с помощью этой команды ты сможешь продолжить чтение, либо начать'''
}